...
equal the current remote tip of `main`, which only receives reviewed
changes through the required checks; a historical ancestor is refused. Validator code is checked out from
