...
test('background transcription cannot issue a second native conversation end',async()=>{
  ...
  const pipeline=new Pipeline({store,analysisBudget:{reserve(){}},config:{analyzer:{},discord:{operators:['a']},worker:{actions:[]}},analyzer:{analyze:async()=>({summary:'終了',intents:[],replyRequested:false,reply:'',voiceAction:'end_conversation'})},onVoiceAction:async()=>actions++});
