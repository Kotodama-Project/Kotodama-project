...
| [Official Cloudflare OS](cloudflare-os/README.md) | exact starter/core pin、content-free Gatekeeper projection adapter | local source/schema/synthetic PASS only; no install or provider execution |
