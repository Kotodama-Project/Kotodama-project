# Documentation revision history (R91 to R179)

この文書は historical です。2026-08-02 から 2026-08-05 にかけての公開 documentation revision（R91〜R179）の
経緯を保存するもので、現在の `main` の状態を示しません。現在地は [STATUS.md](../STATUS.md)、
未完了の gate は [ROADMAP.md](../ROADMAP.md)、次の仕事は GitHub milestones を参照してください。

This document is historical. It preserves the R91 to R179 documentation revision
narrative moved out of STATUS.md and ROADMAP.md on 2026-09-14 and does not describe
the current state of `main`. Commit and tree hashes below refer to the revisions
named at the time and are not current fixed points.

## Moved from STATUS.md
