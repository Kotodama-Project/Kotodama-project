...
class CloudflareCandidateCIContractTests(unittest.TestCase):
    def test_ci_is_read_only_secret_free_hash_locked_and_candidate_focused(self) -> None:
        ...
        # `requirements-ci.txt` is the core hash-locked dependency set shared by
        # the repository workflows (the opt-in Task swarm keeps its heavier SDK
        # closure in requirements-task-swarm-ci.txt), generated by pip-compile
