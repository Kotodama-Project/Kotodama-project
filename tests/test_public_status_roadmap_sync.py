...
class PublicStatusRoadmapSyncTests(unittest.TestCase):
    ...
    def test_public_status_and_roadmap_bind_r146_current_surface(self) -> None:
        ...
        for marker in (
            ...
            "21a4a23586ebfd653a56d7c4b82a778d3791d6ed",
            "7a151d62026f4381c4c2734bcbc841797ee9f554",
            "docs/SCHEMA-VALIDATOR-MATRIX.md",
            "test_schema_validator_matrix_docs.py",
            "Review Request",
            "Review Response",
            "Review Decision Handoff",
            "R144 remains historical",
            "R143 remains historical",
        ...
        for marker in (
            "R146 is the latest public documentation revision",
            "Review Request, Review Response, and Review Decision Handoff",
            "21a4a23586ebfd653a56d7c4b82a778d3791d6ed",
            "7a151d62026f4381c4c2734bcbc841797ee9f554",
            "R144 remains historical",
            "R143 remains historical",
        ...
        self.assertNotIn(
            "R145 is the current public documentation revision",
            status_flat,
        )
        self.assertNotIn("R145 is the latest public documentation revision", roadmap_flat)
    ...
    def test_public_status_and_roadmap_preserve_r107_fixed_point_history(self) -> None:
        ...
        self.assertIn("R146 is the latest public documentation revision", roadmap_flat)
