...
class PublicStatusRoadmapSyncTests(unittest.TestCase):
    def test_public_orientation_promotes_r178_and_preserves_r177_to_r172_history(self) -> None:
        ...
        for surface, text in (("status", status_flat), ("roadmap", roadmap_flat)):
            current = (
                "R178 is the current public documentation revision"
                if surface == "status"
                else "R178 is the latest public documentation revision"
            )
            for marker in (
                current,
                "d5d6187c7e5e7b6c4fe44e4b60a8aa096d4e8dc0",
                "efeffdaa7147fd83d763398c1c205f3708a67630",
    ...
    def test_public_orientation_preserves_r166_r165_r164_r163_history_under_r178(self) -> None:
        status = (ROOT / "STATUS.md").read_text(encoding="utf-8")
        roadmap = (ROOT / "ROADMAP.md").read_text(encoding="utf-8")
        status_flat = " ".join(status.split())
        roadmap_flat = " ".join(roadmap.split())
    ...
    def test_public_status_and_roadmap_bind_r178_current_surface(self) -> None:
        status = (ROOT / "STATUS.md").read_text(encoding="utf-8")
        roadmap = (ROOT / "ROADMAP.md").read_text(encoding="utf-8")
        status_flat = " ".join(status.split())
        roadmap_flat = " ".join(roadmap.split())
        ...
        for marker in (
            "R178 is the latest public documentation revision",
            "97dca324e28777d4618abf53804f47db995e5abc",
            "9e4ad41d7f79ef6d2d9096ebccaad276ff03615c",
            "Company Pack Catalog",
            "Company Pack Guided Next Steps",
    ...
    def test_public_status_and_roadmap_preserve_r107_fixed_point_history(self) -> None:
        ...
        self.assertIn("R178 is the latest public documentation revision", roadmap_flat)
