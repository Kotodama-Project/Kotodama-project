...
class PublicStatusRoadmapSyncTests(unittest.TestCase):
    ...
    def test_public_status_and_roadmap_bind_r153_readme_artifact_map_current(self) -> None:
        ...
        for marker in (
            "R153 is the current public documentation revision",
        ...
        for marker in (
            "R153 is the latest public documentation revision",
            "92b574129ada8d9af2fc2a95e29cdd92590a5dd8",
            "b8d981464e18c31e448b3b57d3bb758ad6f67ae2",
            "README Document Map",
            "review-chain artifact map",
    ...
    def test_public_status_and_roadmap_preserve_r107_fixed_point_history(self) -> None:
        ...
        self.assertIn("R153 is the latest public documentation revision", roadmap_flat)
