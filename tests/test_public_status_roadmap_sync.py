...
class PublicStatusRoadmapSyncTests(unittest.TestCase):
    def test_public_status_and_roadmap_bind_r151_entry_surfaces_current(self) -> None:
        ...
        for marker in (
            "R151 is the current public documentation revision",
        ...
        for marker in (
            "R151 is the latest public documentation revision",
            "7633f0d4996c1bd210fb68b65fb12ff81c7fe4b7",
            "5bcb3b231e1377b3505e51385b57feb04f607361",
            "Company Pack Guided Next Steps",
            "Schema / Validator / Test Matrix",
    ...
    def test_public_status_and_roadmap_preserve_r107_fixed_point_history(self) -> None:
        ...
        self.assertIn("R151 is the latest public documentation revision", roadmap_flat)
