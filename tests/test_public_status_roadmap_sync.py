...
class PublicStatusRoadmapSyncTests(unittest.TestCase):
    def test_public_status_and_roadmap_bind_r125_company_starter_surface(self) -> None:
        ...
        for marker in (
            "R125 is the current public Company Starter entry-navigation revision",
            "a5d052d425c9236a5cdb118a796b936ba74232aa",
            "bca093039d31b3b0f7c595ec91d8224f7419bd7c",
            "examples/company-starter/README.md",
            "test_company_starter_entry_navigation.py",
            "ideal/current/smoke",
        ...
        for marker in (
            "R125 is the latest public documentation revision",
            "Company Starter entry navigation",
            "a5d052d425c9236a5cdb118a796b936ba74232aa",
            "bca093039d31b3b0f7c595ec91d8224f7419bd7c",
            "R124 remains historical",
    ...
    def test_public_status_and_roadmap_preserve_r107_fixed_point_history(self) -> None:
        ...
        self.assertIn("R125 is the latest public documentation revision", roadmap_flat)
