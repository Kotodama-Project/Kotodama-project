...
R163 is the current public documentation revision and the latest
...
`authority: navigation_only` boundaries. The direct entry links to Company Pack
Catalog, Company Pack Guided Next Steps, and Schema / Validator / Test Matrix,
the review-chain language, `read-only/candidate-only`, and
