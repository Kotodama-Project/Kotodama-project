...
| [Owner-confirmed Company AGI direction](docs/OWNER-INTENT-COMPANY-AGI.md) | Canonical product direction; documentation only, runtime remains unimplemented, `NO_GO_UNPUBLISHED` |
