...
[Company Pack Catalog](../../docs/COMPANY-PACK-CATALOG.md)と
[Public Preview Self-check](../../docs/PUBLIC-PREVIEW-SELF-CHECK.md)を参照してください。
...
POSIX shellでは`python3 tools/build_company_pack_review_bundle.py work/my-company`を実行します。bundleは候補bytesを固定するだけで、Human approval、runtime、Promotion、Current Truth、Final Human GOを作りません。
