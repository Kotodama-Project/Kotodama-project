...
| [Hierarchy](hierarchy/README.md) | project → phase → requirement → plan → task の候補階層 | A017 re-authored candidate; admission recorded with provenance (Issue #25) |
...
| Hierarchy | project、phase、requirement、plan、taskの親子関係と証拠・rollback境界 | [A017 hierarchy candidate](hierarchy/README.md)をcopyし、標準ライブラリvalidatorで検査。admissionはIssue #25のowner判断と出典表で記録 |
